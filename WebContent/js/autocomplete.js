  ...
  setOptions: function(options) 
  {
    this.options = Object.extend({
       ...
       selector     : function(instance) 
       {
         ...
         for (var i = 0; instance.options.array != null && i < instance.options.array.length && ret.length < instance.options.choices ; i++) 
         {
           ...
           if(instance.options.displayItemsThatDontMatchInput && foundPos == -1)//Display italic return element with no match of the input (for a default choice)
             ret.push("<li><i>" + elem + "</i></li>");
         }
