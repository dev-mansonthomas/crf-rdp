...
{
  if(miWm.dispositifWindow==null)
  {
    miWm.dispositifWindow = new Window ('dispositif_window', {title: "Ajout d'un Nouveau Disposifit", className: "alphacube2", resizable:true, draggable:true});   
    miWm.dispositifWindow.setContent   ('DispositifEdit', true, false);
    miWm.dispositifWindow.setLocation  (60, 5);
//    this.dispositifWindow.setStatusBar ('');
  ...
  miWm.dispositifWindow.setSize(465, 672);
...
{
  miWm.dispositifWindow.setOpacity(0);
...
MonitorInputDispositifCs.prototype.createNewEmptyDispositifReturn=function(dispositif)
{
  ...
  miWm.dispositifWindow.toFront();
  miWm.dispositifWindow.show   (); 
};
...
MonitorInputDispositifCs.prototype.displayCurrentEquipierRoleToAdd=function(equipierRank)
{
  ...
  {
    crfIrpUtils.error('Veuillez choisir le type de dispositif avant d\'ajouter des équipiers');
    return;
  }
...
MonitorInputDispositifCs.prototype.dispositifSetAutreDelegation=function()
{
  ...
  miWm.autreDelegationWindow.destroy(); 
};
