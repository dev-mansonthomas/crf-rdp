...
{
	if(miWm.interventionWindow==null)
  {
    miWm.interventionWindow = new Window ('intervention_window', {title: windowTitle, className: "alphacube2", resizable:true, draggable:true});   
    miWm.interventionWindow.setContent   ('InterventionTicket', true, false);
    miWm.interventionWindow.setLocation  (65, 25);
    
    crfIrpUtils.setupCalendar("interventionTicketDHReception");
  }
  miWm.interventionWindow.setSize(495, 672);
  miWm.interventionWindow.toFront();
  miWm.interventionWindow.show   ();
};
...
MonitorInputInterventionCs.prototype.createNewEmptyInterventionReturn=function(intervention)
{
  ...
  miInterventionCs.openInterventionTicketWindow("Ajout d'une Nouvelle Intervention"); 
};
